...
export const Header = ({ cart, setCart, setAmountsInCart }) => {
    ...
    return (
        <header className={`${modal ? 'h-screen sticky top-0' : 'sticky top-0'} py-3 px-5 w-s  overflow-auto bg-primary`}>
                ...
                {({ handleSubmit }) => (
                    <form onSubmit={(e) => {
                        ...
                        <div className="flex justify-center flex-col gap-5">
                            ...
                            <span className="text-xl text-white">Время: </span><Field className="p-5 bg-fifth placeholder:text-white" type="time" placeholder={"время"} name={"time"} />
